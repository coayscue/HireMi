...
var dchosenJob: [String:AnyObject]? = nil
var dindex: Int? = nil

class YourListings: UITableViewController {
...
//        }
    ...
    override func tableView(tableView: UITableView, didSelectRowAtIndexPath indexPath: NSIndexPath) {
        dchosenJob = jobsToShow![indexPath.row]
        dindex = indexPath.row
        yourJobsController = self
